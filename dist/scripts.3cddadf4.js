...
},{}],"../scripts/customRadio.js":[function(require,module,exports) {
"use strict";
...
function () {
  _createClass(CustomRadio, [{
    ...
    value: function render() {
      ...
      this.ColorButtons = this.container.getElementsByClassName('color-button'); //Set first element as selected

      this.ColorButtons[0].setAttribute('id', 'color-selected'); //Set each button's color
      ...
      try {
        for (var _iterator = this.ColorButtons[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var button = _step.value;
          button.style = "background-color: ".concat(button.attributes[1].nodeValue);
        }
      } catch (err) {
      ...
      try {
        var _loop = function _loop() {
          ...
          button.addEventListener('click', function () {
            ...
            var colorChangeEvent = new CustomEvent('color-changed', eventOptions);

            _this.container.dispatchEvent(colorChangeEvent);

            var prevSelectedButton = document.getElementById('color-selected');
            prevSelectedButton.removeAttribute('id');
            button.setAttribute('id', 'color-selected');
          });
        };

        for (var _iterator2 = this.ColorButtons[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          _loop();
        }
      } catch (err) {
    ...
    value: function markup(_ref) {
      ...
      try {
        for (var _iterator3 = colors[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          buttons += "<button class='color-button' color=".concat(color, "></button>");
        }
      } catch (err) {
  ...
  function CustomRadio(container, colors) {
    _classCallCheck(this, CustomRadio);

    this.colors = colors; // The constructor should only contain the boiler plate code for finding or creating the reference.
...
},{}],"../scripts/domFuncs.js":[function(require,module,exports) {
replacePostIts = function replacePostIts(data) {
  ...
  for (var item in data.data) {
    var postIt = createPostIt(data.data[item]);
    messageBoard.append(postIt);
  }
};

createPostIt = function createPostIt(data) {
  var posX = data.posX,
      posY = data.posY,
      text = data.text,
      color = data.color;
  var messageNode = createDiv('message', text);
  var postIt = createDiv('post-it');
...
createDiv = function createDiv() {
  ...
  var text = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
...
addStyle = function addStyle(node, posX, posY, color) {
  var style = 'margin-top: ' + addPx(posY) + ' ' + 'margin-left: ' + addPx(posX) + 'background-color: ' + color + ';';
  node.setAttribute('style', style);
};

addPx = function addPx(val) {
  return val + 'px;';
};
},{}],"../scripts/serverCom.js":[function(require,module,exports) {
"use strict";
...
function postMessage(_x, _x2, _x3, _x4) {
...
function _postMessage() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(text, posX, posY, color) {
    var messageJSON, response, jsonResponse;
...
},{"./domFuncs.js":"../scripts/domFuncs.js"}],"../scripts/dragAndDrop.js":[function(require,module,exports) {
"use strict";
...
var BOX_SHADOW_VAL = '0 2px 6px 0 rgba(0, 0, 0, 0.2), 0 5px 10px 0 rgba(0, 0, 0, 0.08)';
var position = {
  x: 0,
  y: 0
};
...
},{"interactjs":"../../../node_modules/interactjs/dist/interact.js","./serverCom.js":"../scripts/serverCom.js"}],"../scripts/index.js":[function(require,module,exports) {
"use strict";
...
var _customRadio = _interopRequireDefault(require("./customRadio.js"));
